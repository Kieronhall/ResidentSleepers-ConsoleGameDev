...
IL_0124:
	...
	}
	{
		...
		int32_t L_76 = V_13;
		DivideByZeroCheck(((int32_t)il2cpp_codegen_subtract(L_75, L_76)));
...
IL_001f:
	{
		...
		DivideByZeroCheck(((int32_t)il2cpp_codegen_subtract(L_8, L_9)));
...
IL_0039:
	...
	}
	{
		...
		DivideByZeroCheck(((int32_t)il2cpp_codegen_add(L_20, L_21)));
...
IL_00dd:
	{
		...
		DivideByZeroCheck(((int32_t)il2cpp_codegen_add(L_56, 1)));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Queue_Enqueue_m0128D3EC88636F987C43B07A337E46D6734EEE0E (Queue_t82FD2BE12D138AF4D22C801CB5044DAEC2BA66BC* __this, RuntimeObject* ___0_obj, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		DivideByZeroCheck(((int64_t)((int32_t)100)));
